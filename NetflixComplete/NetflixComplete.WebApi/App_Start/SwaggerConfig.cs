...
using NetflixComplete.WebApi;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace NetflixComplete.WebApi
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Netflix API")
                            .Description("This API provides easy-to-use, convenient access to Netflix's public API.")
                            .Contact((contact) => contact.Email("netflix@bluevisionsoftware.com").Name("James Henry").Url("https://netflixapi.azurewebsites.net"));
